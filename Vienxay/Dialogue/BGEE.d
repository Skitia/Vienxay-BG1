...
CombatCounter(0)
!See([ENEMY])
Global("X3VienDorn1","GLOBAL",0)~ THEN BDORN X3VienDorn1
...
== BDORN @5 // ~You are also very good at killing.~
...
CombatCounter(0)
!See([ENEMY])
Global("X3VienNeera1","GLOBAL",0)~ THEN BNEERA X3VienNeera1
...
== BNEERA @11 // ~How do you make any friends at all?~
...
== BRASAAD @14 // ~I will forgive your lack of understanding of the principles of the monastic way, Vienxay. The body is a weapon of its own.~
== X3VienB @15 // ~We are far beyond the necessity of such. Weapons, magic. Get with the times.~
== BRASAAD @16 // ~Perhaps you would like a lesson to learn more of what you scold of so ignorantly?~
...
== BDORN @19 // ~That seems a half compliment, elf.~
...
== BNEERA @23 // ~It's a commitment to a practice. One that is very difficult to exit once you've started.~ 
== X3VienB @24 // ~So I suppose anyone can do it?~
== BNEERA @25 // ~Not anyone. Nor should anyone. I would be very worried if you started casting wild magic.~
== X3VienB @26 // ~Jealousy doesn't look good on you, mutt.~
== BNEERA @27 // ~Actually, I'd have a laugh if you transformed yourself into a cow. If you want to learn, I'm not stopping you.~
EXIT 
...
CombatCounter(0)
!See([ENEMY])
Global("X3VienDorn1","GLOBAL",2)~ THEN BDORN X3VienDorn3
...
== BDORN @30 // ~Price often can be mitigated.~
...
== BNEERA @33 // ~Vienxay, how many times do I have to say it...I am not a mutt.~ 
== X3VienB @34 // ~Shut up. I'm trying to protect the group's most prized asset. Myself.~
== BNEERA @35 // ~Oh wow. My eyes are rolling. Let me get a vote on that.~
EXIT 
...
== BRASAAD @37 // ~You aim to make me react. But I see your light, Vienxay. You do not continue this practice. You have learned.~
...
== BRASAAD @39 // ~And yet you have been enlightened that the darkness's seduction is not to be embraced. It is commendable.~
